import { CreateEscrowRequest, CreateEscrowResponse, Escrow, Feedback } from '@/types/escrow';
...
class ApiClient {
  ...
  // Feedback endpoints
  async submitFeedback(walletAddress: string, feedbackText: string, rating?: number) {
    return this.request('/feedback', {
      method: 'POST',
      body: JSON.stringify({ walletAddress, feedbackText, rating }),
    });
  }
